    ...
    public partial class MainForm : Form
    {
        public MainForm()
        {
            ...
            button_inParking.Click += (s, e) =>
            {
                ...
                else if (textBox_carNumber.Text.Trim().Equals(""))
                ...
                else
                {
                    try
                    {
                        ...
                        else //해당 공간이 비어서 주차가 가능한 경우
                        {
                            ...
                            dataGridView_parkingCar.DataSource = DataManager.Instance.parkingAreas;
        ...
        private void Button_select_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in DataManager.Instance.parkingAreas)
            {
                ...
                //다만 권장 사항은 아님
                if (item.parkingSpot.ToString() == textBox_parkingSpotArea.Text)
                {
                    parkingCar = item.carNumber;
                    break;
                }
            }
            string contents = "";
        ...
        {
            psManager(int.Parse(textBox_parkingSpotArea.Text), "delete");
        }

        private void Button_insert_Click(object sender, EventArgs e)
        {
            psManager(int.Parse(textBox_parkingSpotArea.Text), "insert");
        }
